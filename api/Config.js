...
export const baseApiUrl = "http://192.168.254.199:8080";
export const baseKeyCloakUrl = "http://192.168.254.199:8280";
export const baseKeyCloakCompleteUrl =
  "http://192.168.254.199:8280/realms/speedyslotz-dev/protocol/openid-connect/auth";
export const keycloakTokenCompleteUrl =
  "http://192.168.254.199:8280/realms/speedyslotz-dev/protocol/openid-connect/token";
